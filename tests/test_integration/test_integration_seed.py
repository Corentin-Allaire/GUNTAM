...
class TestFullIntegration:
    ...
    def test_read_and_preprocessing(self, temp_dir, test_data_dir, use_space_point, output_format):
        ...
        self._run_read_acts_csv(test_data_dir=test_data_dir, use_space_point=use_space_point, output_format=output_format)
    ...
    def _run_training(self, input_path, input_tensor_path, model_path, dataset_name, input_format, loss_components=None):
        ...
        cmd = [
            ...
            "--dim_embedding",
            "64",  # Small embedding for testing
            "--nb_heads",
            "2",
            "--learning_rate",
            "1e-4",
    ...
    def _verify_outputs(self, read_output, preprocessing_output, model_path, output_format, use_space_point):
        """
