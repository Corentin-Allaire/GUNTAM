...
class SeedConfig:
    ...
    def __init__(self):
        ...
        self.loss_weights: list[float] = []  # Default weights matching loss_componentsS
        self.loss_config = dict(zip(self.loss_components, self.loss_weights))  # Dictionary mapping loss components to weights
